...
const ShoeRedux = () => {
    ...
    const { data } = useSelector((state) => state.shoeSlice);
    const dispatch = useDispatch();
    useEffect(() => {
        dispatch(shoeActions.setDataShoes(dataShoes));
    }, [dispatch]);
    return (
        <div className='container mt-5'>
            ...
            <div className="row">
                {
                    data.map((shoe) => {
                        return <div key={shoe.id} className="col-3" onClick={() => {
                            dispatch(shoeActions.setShoeDetail(shoe))
                        }}>
                            <div className="card" style={{ width: '18rem' }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <button className="btn btn-primary" onClick={() => {
                                        dispatch(shoeActions.setCarts(shoe))
                                    }}>Add Cart</button>
                                </div>
                            </div>
